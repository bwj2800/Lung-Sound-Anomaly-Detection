...
class MultilevelTCNModel(nn.Module):
    def __init__(self, num_classes):
        ...
        self.fc1 = nn.Linear(512 * 6, 128)  # Combine the output from all three TCN blocks
    ...
    def forward(self, chroma, mfcc, mel):
        ...
        mel_features = torch.cat((mel_features1, mel_features2), dim=1)
        mfcc_features = torch.cat((mfcc_features1, mfcc_features2), dim=1)
        chroma_features = torch.cat((chroma_features1, chroma_features2), dim=1)
