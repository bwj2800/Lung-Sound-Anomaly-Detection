...
class GLUClassifierModule(nn.Module):
    def __init__(self, in_channels):
        ...
        self.fc3 = nn.Linear(15, 1)  # Output 1 for binary classification
...
class RDLINet(nn.Module):
    def __init__(self):
        ...
        self.glu_classifier = GLUClassifierModule(144)
    ...
    def forward(self, x):
        ...
        x = self.glu_classifier(x)                 # Output: 1 (binary classification)
        return x
